...
* _First-order differential patterns_: Some or all pairs of input tables differ only in marginal distributions of either row or column variables. Other pairs share the same underlying joint distribution.
...
<!-- Differences in relationship $X_k \to Y_k$ (interaction) or joint distriution in $K$ conditions.-->
